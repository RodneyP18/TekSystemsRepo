package org.rodneyparshall.rightrx.utility;
...
import static org.rodneyparshall.rightrx.constant.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(CustomUserDetails customUserDetails){
        ...
        return JWT.create().withIssuer(RIGHTRX).withAudience(RIGHTRX_ADMIN)
                .withIssuedAt(new Date()).withSubject(customUserDetails.getUsername())
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try{
            ...
            verifier = JWT.require(algorithm).withIssuer(RIGHTRX).build();
